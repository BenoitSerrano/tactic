    ...
    describe('decode', () => {
        it('should decode a regular question', () => {
            const question: Omit<Question, 'exercise'> = {
                ...
                acceptableAnswersWithPoints: ['2:c3VyZQ==', '2:Y2VydGFpbmU=', '1.5:Ym9m'],
            };

            const decodedQuestion = questionEncoder.decodeQuestion(question);

            expect(decodedQuestion.acceptableAnswersWithPoints).toEqual([
                [
        ...
        it('should decode a texte à trous question', () => {
            const question: Omit<Question, 'exercise'> = {
                ...
                order: 1,
                possibleAnswers: [],
                acceptableAnswersWithPoints: ['2:bGE=|2:bGU=', '2:ZXN0|1.5:ZXQ='],
            };
